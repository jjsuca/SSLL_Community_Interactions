...
setwd("~/Documents/Eco_Cast_Plus_2025/Partial_Plots/PA/For_Pub")
Var_Contribution_Files<-list.files("~/Documents/Eco_Cast_Plus_2025/Partial_Plots/PA/For_Pub", pattern = "\\.csv$")
myfiles = lapply(Var_Contribution_Files, read.csv)
Species_Exact_Names<-c(Species_Exact_Names[1:13],"Lepidochelys olivacea", Species_Exact_Names[14:25])
Species_DFs<-list()
...
setwd("~/Documents/Eco_Cast_Plus_2025/Partial_Plots/Var_Peaks/PA")
Var_Peak_Files<-list.files("~/Documents/Eco_Cast_Plus_2025/Partial_Plots/Var_Peaks/PA", pattern = "\\.csv$")
...
lunar_effects_PA<-Var_Abund_Peaks_Full[Var_Abund_Peaks_Full$Variables=="lunar_rad",]
View(lunar_effects_PA)
write.csv(lunar_effects_PA, "~/Documents/Eco_Cast_Plus_2025/Manuscripts/Lunar_Var_Imp_PA.csv")
...
Full_Var_Imp_Abund_Peak$Species_Name<-Full_Var_Imp_Abund_Peak$Species.Name
Var_Abund_Peaks_Full<- left_join(Full_Var_Imp_Abund, Full_Var_Imp_Abund_Peak, by=c("Species_Name","Variables"))
lunar_effects_PA<-Var_Abund_Peaks_Full[Var_Abund_Peaks_Full$Variables=="julian_end",]
View(lunar_effects_PA)
write.csv(lunar_effects_PA, "~/Documents/Eco_Cast_Plus_2025/Manuscripts/DOY_Var_Imp_PA.csv")
#Ocean_vars<-Abund_Var_Imp[Abund_Var_Imp$Class=="Dynamic Oceanography",]
...
#Mean_Var_Imp$Revised_Imp<-Mean_Var_Imp$Mean_Imp

#Ex2<-merge(Ex1, Mean_Var_Imp, by.x="Variable", by.y=c("Variables"), all.x=TRUE)
...
#dev.off()
Ex2<-Ex1[Ex1$Species_Name!="Xiphias gladius" & Ex1$Species_Name!="Lepidochelys olivacea",]
Ex2$Normalized_Val[Ex2$Variable_Names=="Lunar Cycle"]<-NA

png("~/Documents/Eco_Cast_Plus_2025/Figures/SSLL_CPUE_New_Method_PA.png", height=8, width=9, units="in", res=300)
...
png("~/Documents/Eco_Cast_Plus_2025/Figures/Spiciness_Space_CPUE_New_Method_SSLL_PA.png", height=7, width=8, units="in", res=300)
